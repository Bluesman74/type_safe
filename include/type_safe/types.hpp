...
namespace type_safe
{
    ...
    namespace detail
    {
        ...
        {            
           static CONSTDATA auto value = static_cast<int>(C) - static_cast<int>('0');
        };                 

        template <char C>
        struct to_digit_impl<C, lower_hexadecimal_digit>
        {
            static CONSTDATA auto value = static_cast<int>(C) - static_cast<int>('a') + 10;
        };
...
#if !defined(TYPE_SAFE_NO_LITERALS)
